...
public class NetServerHandler extends NetHandler implements ICommandListener {
    ...
    public void a(Packet133Money packet){
        ...
        PlayerMoneyAskEvent event = new PlayerMoneyAskEvent((float) packet.money, this.getPlayer());
        this.server.getPluginManager().callEvent(event);
  ...
  public void a(Packet135Guilde packet){
  	...
  	PlayerGuildeAskEvent event = new PlayerGuildeAskEvent(guilde, packet.guildeRank, this.getPlayer());
  	this.server.getPluginManager().callEvent(event);
  ...
  public void a(Packet134Job packet){
        ...
        PlayerJobAskEvent event = new PlayerJobAskEvent(job, jobLevel, jobExperience, jobMaxExperience, this.getPlayer());
        this.server.getPluginManager().callEvent(event);
        if(job != event.getJob())
        {
